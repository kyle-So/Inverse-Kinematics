...
%  A0 =  [cosd(t0) -sind(t0)*cosd(alpha0) sind(t0)*sind(alpha0) a1*cosd(t0);
%         sind(t0) cosd(t0)*cosd(alpha0)  -cosd(t0)*sind(alpha0) a1*sind(t0);
...
disp('-------------------------------------------------- ');
disp('로봇 6축 자코비안');
So_Jacobian5 = [J1 J2 J3 J4 J5 J6,J7]
...
%% 위에까지가 자코비안 문자로 구한거. 여기는 숫자 대입해서 확인.
% t1=0    ; d1 = 1          ; a1=0         ;  alpha1 =  90;
% t2=0    ; d2 = 0          ; a2=0         ;  alpha2 = -90;
% t3=0    ; d3 = 1          ; a3=0         ;  alpha3 =  90;
% t4=0    ; d4 = 0          ; a4=0         ;  alpha4 = -90;
% t5=0    ; d5 = 1          ; a5=0         ;  alpha5 =  90;
% t6=0    ; d6 = 0          ; a6=0         ;  alpha6 = -90;
% t7=0    ; d7 = 1          ; a7=0         ;  alpha7 =   0;
% 
% De_theta1 = So_Rad_to_Deg(t1);
% De_theta2 = So_Rad_to_Deg(t2);
% De_theta3 = So_Rad_to_Deg(t3);
% De_theta4 = So_Rad_to_Deg(t4);
% De_theta5 = So_Rad_to_Deg(t5);
% De_theta6 = So_Rad_to_Deg(t4);
% De_theta7 = So_Rad_to_Deg(t5);
