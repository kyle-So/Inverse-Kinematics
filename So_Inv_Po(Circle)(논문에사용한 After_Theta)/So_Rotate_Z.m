function [ Return_Theta1, Return_Theta2, Return_Theta3, Return_Theta4, Return_Theta5, Return_Theta6, Return_Theta7 ] = So_Rotate_Z( X,Y,Z,Roll,t1,t2,t3,t4,t5,t6,t7 )
%SO_ROTATE_Z Summary of this function goes here
...
section = 1000;
%%%%%%%%%%%%%%%%%%%% 여기만 입력해 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
Object_PTheta = [ X ; Y ; Z ; (pi/180)*World_RPY(1) ; (pi/180)*World_RPY(2) ; (pi/180)*Roll]; % 목표값 입력   NOA는 Rad으로 적어야함.
