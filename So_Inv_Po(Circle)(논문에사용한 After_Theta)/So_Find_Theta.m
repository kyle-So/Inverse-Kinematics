...
% % 첫번째 점 찍는위치
% t1 = 1.0273*(pi/180)   ; d1=278        ; a1=0         ;  alpha1 =  -90;
% t2 = 26.7050*(pi/180)   ; d2=0          ; a2=0         ;  alpha2 =   90;
% t3 = -29.5033*(pi/180)   ; d3=425        ; a3=0         ;  alpha3 =  -90;
% t4 = 89.3128*(pi/180)   ; d4=0          ; a4=0         ;  alpha4 =   90;
% t5 = -41.5387*(pi/180)   ; d5=425        ; a5=0         ;  alpha5 =  -90;
% t6 = -38.9685*(pi/180)   ; d6=0          ; a6=0         ;  alpha6 =   90;
% t7 = -51*(pi/180)   ; d7=72        ; a7=0          ;  alpha7 =    0;


% 이동점
% % 
% t1 = 0.4376*(pi/180)   ; d1=278        ; a1=0         ;  alpha1 =  -90;
% t2 = 23.9315*(pi/180)   ; d2=0          ; a2=0         ;  alpha2 =   90;
% t3 = -28.7723*(pi/180)   ; d3=425        ; a3=0         ;  alpha3 =  -90;
% t4 = 85.3260*(pi/180)   ; d4=0          ; a4=0         ;  alpha4 =   90;
% t5 = -48.9989*(pi/180)   ; d5=425        ; a5=0         ;  alpha5 =  -90;
% t6 = -34.4479*(pi/180)   ; d6=0          ; a6=0         ;  alpha6 =   90;
% t7 = -43.6749*(pi/180)   ; d7=72        ; a7=0          ;  alpha7 =    0;



% 이동후 점

% t1 = 33.1624*(pi/180)   ; d1=278        ; a1=0         ;  alpha1 =  -90;
% t2 = 33.3688*(pi/180)   ; d2=0          ; a2=0         ;  alpha2 =   90;
% t3 = -41.5815*(pi/180)   ; d3=425        ; a3=0         ;  alpha3 =  -90;
% t4 = 76.2417*(pi/180)   ; d4=0          ; a4=0         ;  alpha4 =   90;
% t5 = -9.1148*(pi/180)   ; d5=425        ; a5=0         ;  alpha5 =  -90;
% t6 = -15.7548*(pi/180)   ; d6=0          ; a6=0         ;  alpha6 =   90;
% t7 = -70.2886*(pi/180)   ; d7=72        ; a7=0          ;  alpha7 =    0;
...
section = 1000;
%%%%%%%%%%%%%%%%%%%% 여기만 입력해 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
Object_PTheta = [680 ; 70 ; 550 ; (pi/180)*(40) ; (pi/180)*0 ; (pi/180)*(0)]; % 목표값 입력   NOA는 Rad으로 적어야함.
...
% for i=1:1:1
             ...
             History_Theta([1 2 3 4 5 6 7],i+1) = Theta([1 2 3 4 5 6 7],i+1) * 180/ pi ;
             % 확인차 사용한 식들.
