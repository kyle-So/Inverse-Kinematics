function [ Get_Theta ] = So_Fine_Theta_Cal( X,Y,Z, Yaw, Picth, Roll )
...
t1    ; d1=278      ; a1=0         ;  alpha1 =   90;
t2    ; d2=0          ; a2=0         ;  alpha2 =  -90;
t3    ; d3=425      ; a3=0         ;  alpha3 =   90;
t4    ; d4=0          ; a4=0         ;  alpha4 =  -90;
t5    ; d5=326       ; a5=0         ;  alpha5 =   90;
t6    ; d6=0          ; a6=0         ;  alpha6 =  -90;
t7    ; d7=171      ; a7=0         ;  alpha7 =    0;

% (X,Y,Z,0,0,롤) 계산
% 1. 함수(X,Y,Z,0,0,롤) -> X,Y,Z,롤 까지계산한 세타1~세타7 나옴
[ThetaZ1,ThetaZ2,ThetaZ3,ThetaZ4,ThetaZ5,ThetaZ6,ThetaZ7] = So_Rotate_Z(X,Y,Z,Roll);
disp('롤 맞춘 처음 세타값')
...
Get_Theta = [Theta1,Theta2,Theta3,Theta4,Theta5,Theta6,Theta7]*(180/pi)
disp('====================================================================')
%% 그래프 그리기
%   세타 모양 나오기

Plot_Theta([1 2 3 4 5 6 7],1) = [90; 90; 90; 90; 90; 90; 90];
