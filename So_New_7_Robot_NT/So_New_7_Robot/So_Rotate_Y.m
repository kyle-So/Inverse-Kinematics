function [ Return_Theta1, Return_Theta2, Return_Theta3, Return_Theta4, Return_Theta5, Return_Theta6, Return_Theta7 ] = So_Rotate_Y( X,Y,Z, Picth, ThetaZ1,ThetaZ2,ThetaZ3,ThetaZ4,ThetaZ5,ThetaZ6,ThetaZ7 )
%SO_RATATE_Y Summary of this function goes here
...
% 
%% NT(?) DH 임시
t1 = ThetaZ1   ; d1=278          ; a1=0         ;  alpha1 =   90;
t2 = ThetaZ2   ; d2=0            ; a2=0         ;  alpha2 =  -90;
t3 = ThetaZ3   ; d3=425          ; a3=0         ;  alpha3 =   90;
t4 = ThetaZ4   ; d4=0            ; a4=0         ;  alpha4 =  -90;
t5 = ThetaZ5   ; d5=326          ; a5=0         ;  alpha5 =   90;
t6 = ThetaZ6   ; d6=0            ; a6=0         ;  alpha6 =  -90;
t7 = ThetaZ7   ; d7=171          ; a7=0         ;  alpha7 =    0;
...
section = 1000;
%%%%%%%%%%%%%%%%%%%% 여기만 입력해 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
Object_PTheta = [ X ; Y ; Z ; (pi/180)*World_RPY(1) ; (pi/180)*Picth ; World_RPY(3)*(pi/180)]; % 목표값 입력   NOA는 Rad으로 적어야함.
